...
void FugitEntry (FSM* _fsm)
{
    ...
    u32 fontoffsetsize = RSC_DISK2.metaData[ RSC_DISK2_METADATA_FUGIT_FONTOFFS_BIN  ].size;
    u32 fontsize       = RSC_DISK2.metaData[ RSC_DISK2_METADATA_FUGIT_FONT_ARJX     ].originalsize;
    u32 fontscansize   = RSC_DISK2.metaData[ RSC_DISK2_METADATA_FUGIT_FONTSCAN_ARJX ].originalsize;
    ...
    ASSERT(LOADgetEntrySize(&RSC_DISK2, RSC_DISK2_FUGIT__FONT_ARJX) < 16000);
    ...
    ARJdepack(g_screens.fugit->fontscan, g_screens.fugit->auxbuffer + RSC_DISK2.metaData[ RSC_DISK2_METADATA_FUGIT_FONTSCAN_ARJX ].offset);   
    STDmcpy  (g_screens.fugit->fontoffset, g_screens.fugit->auxbuffer + RSC_DISK2.metaData[ RSC_DISK2_METADATA_FUGIT_FONTOFFS_BIN ].offset, fontoffsetsize );
